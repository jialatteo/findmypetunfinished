...
class RLostPetPost extends StatefulWidget {
  final snap;
  // final String name;
  ...
  @override
  State<RLostPetPost> createState() => _RLostPetPostState();
}

class _RLostPetPostState extends State<RLostPetPost> {
  @override
        ...
        child: InkWell(
          ...
          onTap: () => {
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        RFullLostPetPost(lostPetPost: widget)))
          },
          child: Container(
...
class RFullLostPetPost extends StatefulWidget {
  final RLostPetPost lostPetPost;
  const RFullLostPetPost({
    Key? key,
    required this.lostPetPost,
  }) : super(key: key);
  @override
  State<RFullLostPetPost> createState() => _RFullLostPetPostState();
}

class _RFullLostPetPostState extends State<RFullLostPetPost> {
